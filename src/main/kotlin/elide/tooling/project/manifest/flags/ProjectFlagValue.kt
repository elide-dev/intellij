...
sealed interface ProjectFlagValue {
   ...
   */
  @Serializable
  sealed interface BooleanTypeValue : ProjectFlagValue {
    val value: Boolean
   ...
   */
  @Serializable
  data object True : BooleanTypeValue {
   ...
   */
  @Serializable
  data object False : BooleanTypeValue {
   ...
   */
  @Serializable
  sealed interface StringTypeValue : ProjectFlagValue {
    val value: String
   ...
   */
  @Serializable
  @JvmInline value class StringValue(override val value: String) : StringTypeValue
}
